 ...
 * generated in the unternehmensclient package. 
...
public class ObjectFactory {
    ...
    private final static QName _Distance_QNAME = new QName("http://distance/", "distance");
    private final static QName _DistanceResponse_QNAME = new QName("http://distance/", "distanceResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: unternehmensclient
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://distance/", name = "distance")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://distance/", name = "distanceResponse")
